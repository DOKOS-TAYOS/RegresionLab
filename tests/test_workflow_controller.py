...
from fitting.workflow_controller import reload_data_by_type, apply_all_equations
...
class TestApplyAllEquations:
    ...
    def equation_tracker(self) -> dict:
        ...
        return {"current_equation": None, "fit_calls": []}
    ...
    def test_apply_multiple_equations(
        self, test_data: pd.DataFrame, equation_tracker: dict
    ) -> None:
