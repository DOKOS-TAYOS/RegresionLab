...
### 1. Custom Formula Functionality (High Priority)

**Issue**: The custom formula feature doesn't work properly in current version.
...
**Issue**: Slow performance with datasets > 10,000 points
...
**Issue**: Online version goes to sleep after inactivity
