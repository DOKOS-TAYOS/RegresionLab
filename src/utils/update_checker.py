...
def _parse_version(version_str: str) -> Tuple[int, ...]:
    """
    Parse a version string like '0.9.3' or '1.2.3.dev1' into a comparable tuple.
...
def fetch_latest_version(version_url: Optional[str] = None) -> Optional[str]:
    ...
    Returns:
        Version string (e.g. '0.9.3') or None if fetch failed.
    """
    ...
    # Parse version from pyproject.toml: version = "0.9.3"
